...
INSERT INTO "new_Payment" ("amount", "createdAt", "currency", "id", "providerId", "status") SELECT "amount", "createdAt", "currency", "id", "providerId", "status" FROM "Payment";
DROP TABLE "Payment";
...
INSERT INTO "new_Review" ("clientId", "comment", "createdAt", "id", "providerId", "rating", "requestId") SELECT "clientId", "comment", "createdAt", "id", "providerId", "rating", "requestId" FROM "Review";
DROP TABLE "Review";
